...
//
// Metadata values preserve their YAML types (bool, int, string, etc.).
// Cross-language note: Python skills-ref stringifies all values; this
// library preserves them. Callers doing cross-ecosystem comparison should
